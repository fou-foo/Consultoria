...
int main(int argc, char **argv)
{
	...
	{
		if ((ParetoFront[i][2] <= candidato1[2]) )// &
			//((ParetoFront[i][2] + ParetoFront[i][1]) > (candidato1[1] + candidato1[2])))//comparamos riesgo
		{
			candidato2[3] = ParetoFront[i][3];
			candidato2[2] = ParetoFront[i][2];
			candidato2[1] = ParetoFront[i][1];
			candidato2[0] = ParetoFront[i][0];
			if ((candidato2[1] >= candidato1[1]) )
			//	& (
			//	(candidato2[2] + candidato2[1]) >(candidato1[1] + candidato1[2])))//comparamos expected value del candidato2
			{
	...
	pareto[3] = ParetoFront[(max_iter)*(max_iter)][3];
	...
	for (i = index + 1; i >= 0; i--)
	{
		if ( (ParetoFront[i][1] <= candidato1[1])&
			(	(ParetoFront[i][2] + ParetoFront[i][1]) < (candidato1[1] + candidato1[2])) )//comparamos expected_value
		{
			candidato2[3] = ParetoFront[i][3];
			candidato2[2] = ParetoFront[i][2];
			candidato2[1] = ParetoFront[i][1];
			candidato2[0] = ParetoFront[i][0];
			if ((candidato2[2] >= candidato1[2])& (
				(candidato2[2]+ candidato2[1]) < (candidato1[1] + candidato1[2]) ))//comparamos riesgo del candidato2
			{
				fprintf(fp, "%lf\t%lf\t%lf\t%lf\n", candidato1[0], candidato1[1], candidato1[2], candidato1[3]);
				//printf("Candidato 1: %lf\t%lf\t%lf\t%lf\n", candidato1[0], candidato1[1], candidato1[2], candidato1[3]);
				candidato1[0] = candidato2[0];//se actualiza el candidato 1 como el candidato2 y guardamos el candidato1
